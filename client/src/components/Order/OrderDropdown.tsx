...
const OrderDropdown = () => {
    ...
    const { orderBy } = useAppSelector((state: RootState) => state.survey);
    const dropdownRef = useRef<HTMLDivElement>(null);
    const dispatch = useAppDispatch();
    const handleOrderChange = (order: string) => {
        dispatch(surveyActions.setOrderBy(order));
    };
    useEffect(() => {
    ...
    return (
        ...
        >
            ...
            >
                Order <ArrowDown className="ml-3 w-3 h-3" />
            </button>
            <div
                data-role="menu"
                className={`${
                    ...
                    >
                        <div className="inline-flex items-center">
                            ...
                            >
                                <input
                                    type="checkbox"
                                    defaultChecked={option.value === "asc"}
